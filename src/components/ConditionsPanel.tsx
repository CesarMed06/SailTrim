        ...
        <div className="space-y-10">
          ...
          <div className="bg-ocean-900/30 border border-ocean-800/30 rounded-3xl p-6 md:p-8">
            <h3 className="text-sm font-semibold text-sail-500 uppercase tracking-wider mb-5 flex items-center gap-2">
              ...
              {t('conditions.seaState')}{' '}
              <span className="text-sail-700 font-normal normal-case">({t('conditions.seaOptional')})</span>
            </h3>
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-3 px-5 py-3 bg-ocean-900/40 border border-ocean-800/30 rounded-full">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-sail-500">{t('conditions.barco')}</span>
            </div>
            <div className="w-px h-3 bg-ocean-700/50" />
            <div className="flex items-center gap-1.5">
              <div className="w-2 h-2 rounded-full bg-emerald-400" />
              <span className="text-xs text-sail-500">{t('conditions.viento')}</span>
            </div>
            <div className="w-px h-3 bg-ocean-700/50" />
            <div className="flex items-center gap-1.5">
              <div className="w-2 h-2 rounded-full bg-emerald-400" />
              <span className="text-xs text-sail-500">{t('conditions.experiencia')}</span>
            </div>
          </div>
          <p className="text-sail-700 text-xs mt-3">{t('conditions.nextStep')}</p>
        </div>
      </div>
    </section>
  )
